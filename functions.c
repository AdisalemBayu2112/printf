...
/**
 * pring_percent - prints a percent sign
 * @types: A list of argumens
 * @buffer: Buffer array to handle print
 * @flags: Calculates the active fags
 * @width: Get width
 ...
 * @flags: Calculate active flags
 * @width: Get width
 * @precision: Specificatio for precision
 * @size: Size specifier
 *
